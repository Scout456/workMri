...
/*Implant alert page--------------------------------------*/
  ...
  /*Implant guide alert page-----------------------------------------*/
   ...
   /*Cochlear implants--------------------------------------------------*/
    ...
    }else if(pacerValue.toUpperCase() === 'COCHLEAR' || pacerValue.toUpperCase() === 'COCHLEAR IMPLANT' || pacerValue.toUpperCase() === 'CI632' || pacerValue.toUpperCase() === 'CI632' || pacerValue.toUpperCase() === 'CI624' || pacerValue.toUpperCase() === 'CI624'|| pacerValue.toUpperCase() === 'CI622'|| pacerValue.toUpperCase() === 'CI622' || pacerValue.toUpperCase() === 'CI612' || pacerValue.toUpperCase() === 'CI612' || pacerValue.toUpperCase() === 'CI532'|| pacerValue.toUpperCase() === 'CI532' || pacerValue.toUpperCase() === 'CI522' || pacerValue.toUpperCase() === 'CI522'|| pacerValue.toUpperCase() === 'CI512' || pacerValue.toUpperCase() === 'CI512' || pacerValue.toUpperCase() === 'ABI541'|| pacerValue.toUpperCase() === 'ABI541' || pacerValue.toUpperCase() === 'CI422' || pacerValue.toUpperCase() === 'CI422' || pacerValue.toUpperCase() === 'CI24REH' || pacerValue.toUpperCase() === 'CI24RECA' || pacerValue.toUpperCase() === 'CI24REH'|| pacerValue.toUpperCase() === 'CI24RECA' || pacerValue.toUpperCase() === 'CI24REST'|| pacerValue.toUpperCase() === 'CI24REST' || pacerValue.toUpperCase() === 'ABI24M' || pacerValue.toUpperCase() === 'ABI24M' || pacerValue.toUpperCase() === 'CI24R' || pacerValue.toUpperCase() === 'CI24R'|| pacerValue.toUpperCase() === 'CI24M' || pacerValue.toUpperCase() === 'CI24M' || pacerValue.toUpperCase() === 'CI11+11+2M' || pacerValue.toUpperCase() === 'CI22M' || pacerValue.toUpperCase() === 'CI22M'){
