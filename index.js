...
/*Implant alert page----------------------------------------------------*/
   ...
   window.open('https://www.medtronic.com/content/dam/emanuals/neuro/M929535A_a_092_view.pdf', '_blank');
...
}else if(pacerValue.toUpperCase() === 'MEDTRONIC SYNERGY' || pacerValue.toUpperCase() === '7427'){
   window.open('https://www.medtronic.com/content/dam/emanuals/neuro/M939858A_b_027_view.pdf', '_blank');
...
/*Implant alert page--------------------------------------*/
  ...
  /*End of LivaNova-----------------------------------------------------*/
   ...
   window.open('medtronic/medtronic-mitra.pdf', '_blank'); 
